...
from spikingjelly_custom.spikingjelly.datasets.n_caltech101 import NCaltech101
...
if __name__ == "__main__":
    ...
    train_dataset, val_dataset = build_ncaltech101()
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        loss, acc = train(parallel_model, device, train_loader, criterion, optimizer, epoch, scaler, args)
