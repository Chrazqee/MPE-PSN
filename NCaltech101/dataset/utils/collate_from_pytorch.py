...
def collate(batch, *, collate_fn_map: Optional[Dict[Union[Type, Tuple[Type, ...]], Callable]] = None):
    ...
    r"""
            ...
            Args:
                ...
                collate_fn_map: Optional dictionary mapping from element type to the corresponding to collate function.
                  If the element type isn't present in this dictionary,
                  this function will go through each key of the dictionary in the insertion order to
                  invoke the corresponding to collate function if the element type is a subclass of the key.
