...
class BasicConvLayer(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.sn = spiking_neuron(**kwargs)  # MPE_PSN(T, tau, threshold)
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.classifier = nn.Sequential(
            Seq2ANN(nn.Dropout(0.5),
                    nn.Linear(512*W*W, 1024)),
            Seq2ANN(nn.Dropout(0.5),
                    nn.Linear(1024, 512)),
            Seq2ANN(nn.Dropout(0.5),
...
#         pool = Seq2ANN(nn.AvgPool2d(2))
#         self.features = nn.Sequential(
#             BasicConvLayer(n_input[0], 64, 3, 1, 1, spiking_neuron, False, **kwargs),
#             BasicConvLayer(64, 128, 3, 1, 1, spiking_neuron, False, **kwargs),
#             BasicConvLayer(128, 256, 3, 1, 1, spiking_neuron, False, **kwargs),
#             pool,
#             BasicConvLayer(256, 512, 3, 1, 1, spiking_neuron, False, **kwargs),
#             BasicConvLayer(512, 1024, 3, 1, 1, spiking_neuron, False, **kwargs),
...
#             # Seq2ANN(nn.Linear(2048, 1024)),
#             # Seq2ANN(nn.Linear(1024, 512)),
#             Seq2ANN(nn.Linear(1024, n_output)),
#         )
#
#         for m in self.modules():
#             if isinstance(m, nn.Conv2d):
